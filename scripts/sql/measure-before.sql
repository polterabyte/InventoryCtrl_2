-- Baseline profiling before adding new indexes
\timing on
SET random_page_cost = 1.1; -- optional if on SSD
SET enable_seqscan = on;    -- let planner choose

-- InventoryTransactions common patterns
