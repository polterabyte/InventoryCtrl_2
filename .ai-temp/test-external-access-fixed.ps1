# Test script for external access after fixes
param(
    [string]$ServerIP = "192.168.1.100",  # Replace with your server IP
    [int]$Port = 80
)

Write-Host "🔧 Testing external access to Inventory System..." -ForegroundColor Cyan
...
Write-Host "If all tests show ✅, your external access should work correctly." -ForegroundColor White
Write-Host "The key fix was changing API URL from 'localhost:5000' to '/api' for external access." -ForegroundColor White
Write-Host ""
