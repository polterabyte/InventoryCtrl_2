...
Write-Host "   API HTTPS: https://localhost:7000 ✅" -ForegroundColor White
Write-Host "   Web HTTP:  http://localhost:5001  ✅" -ForegroundColor White
Write-Host "   Web HTTPS: https://localhost:7001 ✅" -ForegroundColor White
Write-Host ""
...
Write-Host "✅ Notification status shows 'active'" -ForegroundColor White
Write-Host ""
